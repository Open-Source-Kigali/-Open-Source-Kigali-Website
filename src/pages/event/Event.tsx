...
const ModeBadge = ({ mode }: { mode: OSKEvent["mode"] }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold border ${styles[mode]}`}
    >
  ...
  <div
    ...
    style={
      event.coverImage
        ...
        : {
            background:
              "linear-gradient(135deg, #2b7fff 0%, #1a6fef 50%, #0a5fdf 100%)",
          }
    }
  >
    ...
    {event.coverImage && (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(43,127,255,0.88) 0%, rgba(26,111,239,0.88) 50%, rgba(10,95,223,0.88) 100%)",
        }}
      />
    )}
    <div
    ...
    <div className="relative p-8 md:p-12">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-[#93bbff] font-semibold text-base mb-5">
            {event.tagline}
          </p>
    ...
    <div className="group relative bg-white rounded-2xl overflow-hidden flex flex-col border border-gray-100 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
      ...
      <div className="relative h-48 shrink-0 overflow-hidden">
        {event.coverImage ? (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-5">
              <span
                className="text-8xl font-black text-white/20 leading-none select-none"
        ...
        <div className="absolute bottom-3 left-3">
          ...
          >
            <span
              className="text-2xl font-black text-gray-900 leading-none block"
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <h3
          className={`font-black text-base leading-snug transition-colors duration-200 ${
            isPast
              ? "text-gray-500"
              : "text-gray-900 group-hover:text-[#2b7fff]"
          }`}
        >
          {event.title}
        </h3>
        ...
        <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs text-gray-400 mb-4">
          {event.time && (
            <span className="flex items-center gap-1">
              <Clock size={10} style={{ color: "#5b9fff" }} />
              {event.time}
            </span>
          )}
          {event.location && (
            <span className="flex items-center gap-1">
              <MapPin size={10} style={{ color: "#5b9fff" }} />
              {event.location}
            </span>
          )}
        </div>
...
const Event = () => {
  ...
  const { filtered, filters, setFilter } = useFilter<
    OSKEvent,
    { type: EventType | "all" }
  >({
    items: events,
  ...
  const featured =
    events.find((e) => e.featured) ?? events.find((e) => e.status !== "past");
  const upcoming = filtered.filter(
    (e) => e.status !== "past" && e.id !== featured?.id,
  );
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, rgba(43,127,255,0.08) 1px, transparent 0)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(43,127,255,0.1) 0%, transparent 70%)",
          }}
        />
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 mb-12">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-gray-500 text-base md:text-lg leading-relaxed max-w-lg">
                ...
                Every event is open to all skill levels — and all of them are
                free.
              </p>
            </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Get notified on Discord and WhatsApp before every session,
                meetup, and hackathon.
              </p>
            </div>
          </div>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #2b7fff 0%, #0a5fdf 100%)",
        }}
      >
        <div
          className="absolute inset-0 pointer-events-none"
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl p-7">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              No formal process. Send us a few lines about your idea and we'll
              take it from there.
            </p>
