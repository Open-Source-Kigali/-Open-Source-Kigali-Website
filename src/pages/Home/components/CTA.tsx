...
const CTA = () => {
  ...
  return (
    <section className="relative overflow-hidden py-24 px-4 md:px-20 bg-background-colour">
      {/* Glow blobs */}
      <div className="absolute top-0 left-0 w-80 h-80 rounded-full pointer-events-none bg-[radial-gradient(circle, rgba(59,130,246,0.14) 0%, transparent 70%)]" />
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full pointer-events-none bg-[radial-gradient(circle, rgba(99,102,241,0.11) 0%, transparent 70%)]" />
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative">
          <div className="rounded-2xl overflow-hidden border border-white/10 bg-text-heading shadow-[0_0_0_1px_rgba(59,130,246,0.1),0_32px_64px_rgba(0,0,0,0.5)]">
            {/* Mac-style header */}
